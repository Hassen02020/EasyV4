...
**Ce document est un audit, pas une implémentation.** Aucun code de design n'a été modifié. La
boucle demandée est : captures → audit (ce document) → classement → corrections → nouvelles captures
avant/après — chaque correction devra faire l'objet d'une décision séparée avant d'être appliquée.
...
### 2. Bannière "fournisseur simulé" visible par le client final (Vols, Hôtels Monde)
...
### 3. CTA "Voir le programme" incohérent entre modules
...
### 4. Prix absent des cartes résultat Attractions
...
| 💰 Prix | Visible et bien mis en évidence sur Omraty/Voyages organisés/Vols/Hôtels Monde (gros caractères, couleur rouge/vert selon module). **Absent sur Attractions** (constat 4) — seul point faible. |
| 🔴 CTA | Fort et cohérent sur Omraty et les listes Vols/Hôtels Monde (bouton plein rouge "Réserver"/vert "Voir le programme"). **Affaibli sur Voyages organisés/Attractions** (style outline, constat 3). |
| 🖼️ Images | Absentes partout (constat 1) — le point faible le plus sévère de cet audit, transverse aux 5 modules. |
| 🛡️ Confiance | Bloc de réassurance (paiement sécurisé, support local, agence physique) présent partout — bon réflexe. **Neutralisé par la bannière "fournisseur simulé"** sur Vols/Hôtels Monde (constat 2/8), qui est aujourd'hui le point de rupture de confiance le plus grave du site. |
...
| # | Constat | Priorité | Modules touchés |
|---|---|---|---|
| 2 | Bannière "fournisseur simulé" visible client | **P0 confiance** | Vols, Hôtels Monde |
| 1 | Aucune photo produit (cartes + hero) | **P0 conversion** | Les 5 modules |
| 3 | CTA outline plus faible sur 2 modules | P1 conversion | Voyages organisés, Attractions |
| 4 | Prix absent des cartes Attractions | P1 conversion | Attractions |
| 6 | Hero sans photographie | P1 premium/conversion | Les 5 modules |
| 8 | Badge "Disponibilité Réelle" contredit | P1 confiance | Vols, Hôtels Monde |
| 7 | Mobile non vérifié ce cycle | P1 preuve manquante | Les 5 modules |
| 5 | Pas de signal d'urgence (places restantes) | P2 conversion | Omraty, Voyages organisés |

**Recommandation** : traiter les 2 points P0 en premier (ce sont des défauts de confiance/conversion
directs, pas des raffinements esthétiques), produire un cycle de captures mobile avant de clore le
sujet "preuve visuelle", puis dérouler les P1/P2 avec, pour chacun, une capture avant/après comme
demandé.

---

*Ce document ne modifie aucun composant. Chaque correction listée ci-dessus doit être validée
