 ...
 *
 * Même structure que `voucher-package.tsx`/`voucher-omra.tsx`, adaptée à un
 * billet de vol (PNR + segment au lieu de dates de séjour).
 */
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Voucher de Confirmation Vol</Text>
          </View>
        ...
        <Text style={styles.sectionTitle}>Vol</Text>
        <View style={styles.table}>
          <View style={styles.row}>
            <Text style={styles.cellLabel}>Trajet</Text>
            <Text style={[styles.cellValue, { fontFamily: "Helvetica-Bold" }]}>
              {data.origin} → {data.destination}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.cellLabel}>PNR</Text>
            <Text style={styles.cellValue}>{data.pnr ?? "—"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.cellLabel}>Vol</Text>
          ...
          <View style={styles.row}>
            <Text style={styles.cellLabel}>Cabine</Text>
            <Text style={styles.cellValue}>{data.cabinClass ?? "ECONOMY"}</Text>
          </View>
          <View style={styles.row}>
