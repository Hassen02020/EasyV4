    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <CardContent>
            <div className="flex items-baseline gap-2">
              <p className="text-2xl font-bold">
                {stats.revenueToday.toLocaleString("fr-FR")} DT
              </p>
              <Badge variant="outline" className="text-emerald-600">
                <ArrowUpRight className="mr-1 h-3 w-3" />+{stats.growth}%
              </Badge>
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {stats.revenueMonth.toLocaleString("fr-FR")} DT
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-amber-600">
              {stats.pendingPayments.toLocaleString("fr-FR")} DT
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">
              {MOCK_INVOICES.filter((i) => i.status === "en_attente").length} en
              attente
            </p>
          </CardContent>
        </Card>
                    ...
                    {MOCK_PAYMENTS.map((payment) => (
                      <TableRow key={payment.id}>
                        ...
                        <TableCell className="font-semibold">
                          {payment.amount.toLocaleString("fr-FR")} DT
                        </TableCell>
                        <TableCell>
                          <Badge
                            className={
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-2">
                {["Janvier 2024", "Décembre 2023", "Novembre 2023"].map(
                  (month) => (
                    <Button
                      key={month}
                      variant="outline"
