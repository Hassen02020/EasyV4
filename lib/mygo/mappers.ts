...
export function mapBookingCancellation(
  raw: BookingCancellationResponseT,
): BookingCancellationDTO {
  return {
    bookingId: raw.Booking ?? 0,
    fee: raw.Fee ?? 0,
    currency: raw.Currency ?? "TND",
