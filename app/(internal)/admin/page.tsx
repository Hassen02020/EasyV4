    ...
    <div className="space-y-8 p-6">
      <div className="e2b-fade-in-up flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button
          ...
          asChild
        >
          {/* eslint-disable-next-line @next/next/no-html-link-for-pages -- rechargement complet volontaire (données serveur potentiellement obsolètes), pas une navigation client à optimiser via <Link> ; règle nouvellement déclenchée par la restructuration en route groups (public)/(internal) de la migration i18n, comportement inchangé */}
